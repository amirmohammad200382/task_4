	...
	**************************************************/
	...
	(function( $ ) {
		...
		var ErrorMsgs = {
			...
			callingContextNotSliderInstance : "Calling context element does not have instance of Slider bound to it. Factor your code to make sure the JQuery object returned from the call to the slider() initializer is calling the method"
		};

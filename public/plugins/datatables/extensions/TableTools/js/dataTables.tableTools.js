...
TableTools.prototype = {
	...
	/**
	 * Factor to see if a current row is selected or not
	...
	/**
	 * Factor to see if any of the ZeroClipboard client's attached need to be resized
	 */
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			$(dt.nTBody).on( 'click.DTTT_Select', this.s.custom.sRowSelector, function(e) {
				...
				/* Factor that we are actually working with a DataTables controlled row */
	...
	/**
	 * Factor if the Flash plug-in is available
	 *  @method  _fnHasFlash
